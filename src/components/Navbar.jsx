    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Ezequiel&nbsp;<span className='sm:block hidden'>| Developer</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          />
          <div className={`${!toggle ? 'hidden': 'flex'} p-6 black-gradiend absolute top-20 right-0 mx-4 mt-2 min-w[140px] z-10 rounded-xl `}>
